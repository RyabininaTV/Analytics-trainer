...
(
    ...
    constraint chk_trainers_difficulty_level check (
        difficulty_level is null or difficulty_level in ('EASY', 'MEDIUM', 'HARD')
        )
);

comment on table trainers is 'тренажёры или логические наборы заданий';
comment on column trainers.id is 'уникальный идентификатор тренажёра';
comment on column trainers.title is 'название тренажёра';
comment on column trainers.description is 'описание тренажёра';
comment on column trainers.difficulty_level is 'уровень сложности тренажёра';
comment on column trainers.is_active is 'признак доступности тренажёра';
comment on column trainers.created_at is 'дата и время создания тренажёра';
comment on column trainers.updated_at is 'дата и время последнего обновления тренажёра';
...
comment on column tasks.trainer_id is 'идентификатор тренажёра, к которому относится задание';
...
comment on column user_progress.trainer_id is 'идентификатор тренажёра';
