...
public record CreateTaskResponse(
        ...
        List<CreateTaskOptionResponse> options,

        @JsonProperty("error_items")
        List<CreateTaskErrorItemResponse> errorItems

) {

    @Builder
    public record CreateTaskOptionResponse(
    ...
    @Builder
    @JsonInclude(NON_NULL)
    public record CreateTaskErrorItemResponse(
