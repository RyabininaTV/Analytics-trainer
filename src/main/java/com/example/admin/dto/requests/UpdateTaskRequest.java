...
public record UpdateTaskRequest(
        ...
        List<UpdateTaskOptionRequest> options,

        @JsonProperty("error_items")
        List<UpdateTaskErrorItemRequest> errorItems

) {

    @Builder
    public record UpdateTaskOptionRequest(
    ...
    @Builder
    public record UpdateTaskErrorItemRequest(
