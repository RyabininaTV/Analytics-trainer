...
import static com.example.constants.BaseEndpoints.BASE_LEATHERBOARD;
...
public class LeaderboardController {
    ...
    public static final String BY_TRAINER_ID = "/{trainerId}";
    ...
    @APIResponse(
            ...
            content = @Content(schema = @Schema(
                    type = ARRAY,
                    implementation = LeaderboardItemResponse.class
            ))
    )
