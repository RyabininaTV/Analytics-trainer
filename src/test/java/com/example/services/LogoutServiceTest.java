...
import com.example.services.LogoutService;
...
class LogoutServiceTest {
    ...
    class LogoutTests {
        ...
        void accessAndRefreshTokensAreValid_shouldRevokeBothTokens() {
            ...
            LogoutService logoutService = new LogoutService(revokedTokenRepository, appYaml);
            ...
            verify(revokedTokenRepository, times(2)).create(captor.capture());
        ...
        void refreshTokenIsNull_shouldRevokeOnlyAccessToken() {
            ...
            verify(revokedTokenRepository).create(captor.capture());
            verifyNoMoreInteractions(revokedTokenRepository);
        ...
        void refreshTokenIsBlank_shouldRevokeOnlyAccessToken() {
            ...
            verify(revokedTokenRepository, times(1)).create(any(CreateRevokedTokenRequestEntity.class));
            verifyNoMoreInteractions(revokedTokenRepository);
